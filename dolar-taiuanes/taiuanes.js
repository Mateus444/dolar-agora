	...
	let url = "https://economia.awesomeapi.com.br/json/last/TWD-BRL";
	...
	jsonRetorno.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
      		...
      		let cotacao = retornoParaObject.TWDBRL.bid;
      		let varicao = retornoParaObject.TWDBRL.pctChange;
      		...
      		document.getElementById("variaValor").innerHTML = varicaoFloat;
                let data = retornoParaObject.TWDBRL.create_date;
	  ...
	  function criarTabela() {
	    ...
	    for (let i = 0; i < 10; i++) {
	      ...
	      td_cotacao.innerText = "NT$"+" "+multi[i]+" "+escrito[i];
