	...
	let url = "https://economia.awesomeapi.com.br/json/last/CHF-BRL";
	...
	jsonRetorno.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
      		...
      		let cotacao = retornoParaObject.CHFBRL.bid;
      		let varicao = retornoParaObject.CHFBRL.pctChange;
      		...
      		document.getElementById("variaValor").innerHTML = varicaoFloat;
                 let data = retornoParaObject.CHFBRL.create_date;
