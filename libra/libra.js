	...
	let url = "https://economia.awesomeapi.com.br/json/last/GBP-BRL";
	...
	jsonRetorno.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
      		...
      		let cotacao = retornoParaObject.GBPBRL.bid;
      		let varicao = retornoParaObject.GBPBRL.pctChange;
      		...
      		document.getElementById("variaValor").innerHTML = varicaoFloat;
                let data = retornoParaObject.GBPBRL.create_date;
