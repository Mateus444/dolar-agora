	...
	let url = "https://economia.awesomeapi.com.br/json/last/HKD-BRL";
	...
	jsonRetorno.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
      		...
      		let cotacao = retornoParaObject.HKDBRL.bid;
      		let varicao = retornoParaObject.HKDBRL.pctChange;
      		...
      		document.getElementById("variaValor").innerHTML = varicaoFloat;
                 let data = retornoParaObject.HKDBRL.create_date;
	  ...
	  function criarTabela() {
	    ...
	    for (let i = 0; i < 8; i++) {
	      ...
	      td_cotacao.innerText = "HK$"+" "+multi[i]+" "+escrito[i];
